      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <Link
              to="/"
              className="text-2xl font-bold tracking-tighter bg-gradient-to-r from-white via-red-500 to-red-800 bg-clip-text text-transparent"
            >
              CodiAi
            </Link>
          ...
          {/* Platform Links */}
          <div>
            <h4 className="text-xs font-bold text-zinc-500 uppercase tracking-[0.2em] mb-6">
              Platform
            </h4>
            <ul className="space-y-4">
              <li>
                <Link
                  to="/courses"
                  className="text-zinc-300 hover:text-red-500 transition text-sm"
                >
                  All Courses
                </Link>
              </li>
